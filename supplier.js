...
const doQuery=require('./myModules/doQuery.js');
const {onlyIfLoggedIn, onlyIfLoggedOut}=require("./myModules/protectMyRoutes");
...
(
      ...
      async (req, res, next)=>
      {
            ...
            doQuery('insert into promotionRequest (promotionRequest) values (?);', [promotionRequest], false);
